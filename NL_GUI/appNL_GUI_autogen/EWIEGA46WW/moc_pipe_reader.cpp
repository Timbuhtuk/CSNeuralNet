...
Q_CONSTINIT static const qt_meta_stringdata_CLASSPipeReaderENDCLASS_t qt_meta_stringdata_CLASSPipeReaderENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(129, 9),  // "getResult"
        QT_MOC_LITERAL(139, 3),  // "str"
        QT_MOC_LITERAL(143, 6),  // "setStr"
        QT_MOC_LITERAL(150, 2),  // "st"
        QT_MOC_LITERAL(153, 5)   // "start"
    },
    "PipeReader",
    "QML.Element",
    "auto",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPipeReaderENDCLASS[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       9,    4,   74,    4, 0x06,    9 /* Public */,

 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      14,    1,   83,    4, 0x0a,   14 /* Public */,
      16,    1,   86,    4, 0x0a,   16 /* Public */,

 // methods: name, argc, parameters, tag, flags, initial metatype offsets
      18,    0,   89,    4, 0x02,   18 /* Public */,
